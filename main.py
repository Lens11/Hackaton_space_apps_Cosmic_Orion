...
class Menu:
    def __init__(self, screen):
        ...
        self.games = [
            ...
            [
                ("Ground Fighter Easy", lambda s: ground_fighter.GroundFighterGame(s), "SS1.png", "Ground Fighter Easy"),
                ("Ground Fighter Medium", lambda s: ground_fighter.GroundFighterGame(s), "SS2.png", "Ground Fighter Medium"),
                ("Ground Fighter Hard", lambda s: ground_fighter.GroundFighterGame(s), "SS3.png", "Ground Fighter Hard"),
            ]
        ]
